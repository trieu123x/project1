  ...
  return (
    <>
      <div className=" shadow-2xl border-1 border-gray-300 bg-white fixed top-[72px] left-1/2 -translate-x-1/2 w-[1000px] h-[600px]">
        ...
        <button className=" absolute bottom-12 left-1/2 -translate-1/2 bg-emerald-500 hover:bg-emerald-600 transition-colors duration-300 text-white font-semibold px-4 py-2 rounded-md">
          Tiếp tục
        </button>
      </div>
    </>
