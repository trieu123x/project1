...
{cart && cart.length > 0 && product == null && (
  ...
  <div className="flex flex-col md:flex-row justify-end gap-4 mt-8">
    ...
    <button
            onClick={() => {
              if (!formDataP.cardNumber || !formDataP.cardName || !formDataP.expiry || !formDataP.cvv || !formDataP.city || !formDataP.district || !formDataP.ward || !formDataP.address || !formDataP.phone) {
                setEmes(true);
                setTimeout(()=>{setEmes(false)}, 3000);
                return;
              }
